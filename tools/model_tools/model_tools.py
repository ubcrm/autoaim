...
import json
from robot_aim.led_match.assets.led_pair import LedPair
from robot_aim.led_find.assets.bounding_rect import BoundingRect
    ...
    def create_data(self, data=None):
        ...
        for value in data.values():
            led1 = BoundingRect('', (
                ...
                value['led1']['angle']), {})  # todo: pass config here.. but how?!
            led2 = BoundingRect('', (
                (value['led2']['width'], value['led2']['height']),
                (value['led2']['x_center'], value['led2']['y_center']),
                value['led2']['angle']), {})  # todo: pass config here.. but how?!
